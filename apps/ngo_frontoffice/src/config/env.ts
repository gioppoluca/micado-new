...
export interface RuntimeConfig {
  ...
  /** Keycloak realm used by this NGO application, e.g. "micado" */
  keycloakRealm: string;

  /** Keycloak public client ID for this application, e.g. "micado-pa" */
  keycloakClientId: string;

  /** Public-facing URL of this NGO app (used as Keycloak redirect base) */
  ngoUrl?: string;
...
const DEV_DEFAULTS: RuntimeConfig = {
  ...
  keycloakRealm: 'ngo_frontoffice',
  keycloakClientId: 'ngo_frontoffice',
  ngoUrl: 'http://ngo.localhost',
  migrantDomain: 'localhost',
  titleLimit: 30,
  umamiUrl: 'http://umami.localhost',
  umamiWebsiteId: '33333333-3333-4333-8333-333333333333',
  umamiDomains: 'ngo.localhost',
};
